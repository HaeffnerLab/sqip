...
from sqip.scripts.experiments.Experiments729.rabi_flop_scannable import rabi_flopping_scannable as rf
...
class scan_micromotion(experiment):
    ...
    def run(self, cxn, context):
        ...
        dv_args = {'output_size': 3, #self.rabi_flop.excite.output_size,
                   ...
                   'window_name': 'micromotion',
                   'dataset_name': 'Scan_Micromotion'
                   }
