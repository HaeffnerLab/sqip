...
class calibrate_heating_rates(experiment):
    ...
    required_parameters = [('DriftTracker', 'line_selection_1'),
                           ...
                           ('CalibrationScans', 'do_rabi_flop_axial1'),
                           ('CalibrationScans', 'do_rabi_flop_axial2'),
                           ('CalibrationScans', 'carrier_time_scan'),
                           ('CalibrationScans', 'axial1_time_scan'),
                           ('CalibrationScans', 'axial2_time_scan'),
                           ('CalibrationScans', 'carrier_excitation_power'),
                           ('CalibrationScans', 'axial1_excitation_power'),
                           ('CalibrationScans', 'axial2_excitation_power'),
