...
from excitation_729_PI import excitation_729_PI
...
class rabi_flopping_PI(experiment):
    ...
    required_parameters.extend(heating_parameters)
    optional_parmeters = [
                          ('RabiFloppingPI', 'window_name')
                          ]
    required_parameters.extend(excitation_729_PI.required_parameters)
    ...
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.excite = self.make_experiment(excitation_729_PI)
    ...
    def setup_data_vault(self):
        ...
        window_name = self.parameters.get('RabiFlopping.window_name', ['Rabi Flopping PI'])
...
if __name__ == '__main__':
    ...
    exprt = rabi_flopping_PI(cxn = cxn)
