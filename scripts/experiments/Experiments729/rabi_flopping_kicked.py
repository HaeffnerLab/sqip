...
class rabi_flopping_kicked(experiment):
    
    name = 'RabiFloppingKicked'
    trap_frequencies = [
    ...
    def setup_data_vault(self):
        ...
        window_name = self.parameters.get('RabiFlopping.window_name', ['Rabi Flopping Kicked'])
...
if __name__ == '__main__':
    ...
    exprt = rabi_flopping_kicked(cxn = cxn)
