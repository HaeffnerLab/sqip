...
class rabi_excitation(pulse_sequence):
    ...
    def sequence(self):
        ...
        self.addDDS('729', self.start + frequency_advance_duration, p.rabi_excitation_duration, p.rabi_excitation_frequency, p.rabi_excitation_amplitude + glo.Offset729, p.rabi_excitation_phase)
