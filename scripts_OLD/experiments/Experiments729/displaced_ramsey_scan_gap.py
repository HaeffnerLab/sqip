...
class displaced_ramsey_scan_gap(experiment):
    
    name = 'DisplacedRamseyScanGap'
    trap_frequencies = [
    ...
    optional_parmeters = [
                          ('DisplacedRamseyGap', 'window_name')
                          ]
...
#        self.square_pulse_generator.burst_state(True)
    ...
    def setup_sequence_parameters(self):
        ...
        minim,maxim,steps = self.parameters.PulsedHeat.time_interval_scan
    ...
    def setup_data_vault(self):
        ...
        window_name = self.parameters.get('DisplacedRamseyScanGap.window_name', ['Displaced Ramsey Scan Gap'])
    ...
    def run(self, cxn, context):
        ...
        for i,duration in enumerate(self.scan):
            ...
            self.load_frequency()
            self.parameters['Heating.coherent_evolution_time'] = duration
...
if __name__ == '__main__':
    ...
    exprt = displaced_ramsey_scan_gap(cxn = cxn)
